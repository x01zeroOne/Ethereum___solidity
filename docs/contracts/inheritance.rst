...
``Base1.pause``, resulting in the following sequence of events:
``Paused_Final -> Paused_Base2 -> Paused``, instead of the expected sequence:
``Paused_Final -> Paused_Base2 -> Paused_Base1 -> Paused``.
